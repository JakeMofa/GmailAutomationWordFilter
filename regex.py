...
# Full rejection and interview phrases
REJECTION_PHRASES = [
    "unfortunately",
...
# Helper to create regex pattern for a phrase
...
# Number of patterns created for verification
len(rejection_regex_patterns), len(interview_regex_patterns)
